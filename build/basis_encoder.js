// modified version of https://github.com/BinomialLLC/basis_universal/blob/master/webgl/encoder/build/basis_encoder.js
/*
 *
 * THIS IS A PROMINENT NOTICE STATING THAT I HAVE CHANGED
 * THIS FILE, basis_encoder.js
 *
 */
...
(() => {
  var BASIS = (function () {
    ...
    return function (BASIS) {
              ...
              databaseRequest.onsuccess = () => {
                ...
                fileRequest.onsuccess = () => {
                  if (fileRequest.result === undefined) {
                    reject(
                      new Error(
                        "basis_encoder.wasm is not found in IndexedDB. Perhaps the storage quota has been reached?"
                      )
                    );
                    return;
                  }
                  WebAssembly.instantiate(fileRequest.result.file, info).then(
      ...
      var dynCall_iiiiiiiiiiiiiiiiiiii = (Module[
